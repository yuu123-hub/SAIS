# Workflow: Chinese-to-English Drafting
...
- For assessed work: brief, rubric, and current AI-use policy.
- The student's Chinese ideas, outline, or draft.
- Verified sources and relevant page locations for factual claims.

## Method

1. **Explain first:** Translate the source into Chinese at the requested level: plain-language summary, concept map, or concrete example.
2. **Elicit ownership:** Ask the student for their own Chinese claim, reason, limitation, and provisional conclusion. Do not supply a hidden thesis as if it were theirs.
3. **Check evidence:** Separate the student's interpretation from source-supported facts; identify missing citation or page evidence.
...
- Treating fluent English as evidence of understanding.
- Translating an unsupported Chinese claim into a more confident English assertion.
- Calling an illustrative example causal evidence.
- Using an AI-generated draft when the assessment policy does not permit it.

## Next action

Ask the student to approve the meaning of the Chinese argument before extending it into a longer English draft.
