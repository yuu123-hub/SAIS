...
| module performance, learning outcomes, assessment weights, rubric-to-plan; rubric evidence, criterion mapping; marks or marker feedback; career evidence; optional/dissertation choice | distinction and career evidence loop | `03_workflows/Distinction_and_Career_Evidence_Loop.md`, relevant `04_templates/`, official module/assessment material, project context |
