...
## SAIS operational implication

`AGENTS.md` must treat the current assessment AI-use policy as an authoritative input before generating an English draft intended for submission.
